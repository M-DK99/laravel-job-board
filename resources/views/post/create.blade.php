      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <input type="text" id="title" value="{{ old("title") }}" name="title" autocomplete="given-name"
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <input type="text" id="author" value="{{ old("author") }}" name="author" autocomplete="family-name"
